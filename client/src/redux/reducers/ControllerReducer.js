import { PLAYPAUSE, REWIND, CHANGEBPM,TOGGLEPATTERNVIEW, SETPATTERN, SETPATTERNDISPLAY, STOP, PLAYING, PAUSE } from "../actions/ControllerActions";

const initialState = {
    playingState: STOP,
    bpm:120,
    pattern:{"name":"rock8", "difficulty":"hard", "timeSignature":"4/4","bpm":120,"instruments":[{"type":"snare","patternCode":"0010001000101000"}, {"type": "kick","patternCode": "1000000101000000"}, {"type": "cymbal","patternCode": "1010101010101010"}, {"type": "floor","patternCode": "0001000100010001"}]},    patternDisplay:{"name":"rock", "difficulty":"easy", "timeSignaure":"2/4","bpm":60,"instruments":[{"type":"snare","patternCode":"001000100010"}]},
